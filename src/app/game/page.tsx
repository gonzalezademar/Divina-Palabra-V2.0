...
const completePhraseChallenges = [
    { fullPhrase: "EN EL PRINCIPIO CREO DIOS LOS CIELOS Y LA TIERRA", hint: "GÉNESIS 1:1", reference: "Génesis 1:1" },
    { fullPhrase: "EL SENOR ES MI PASTOR NADA ME FALTARA", hint: "SALMO 23:1", reference: "Salmo 23:1" },
    { fullPhrase: "NO SOLO DE PAN VIVIRA EL HOMBRE", hint: "MATEO 4:4", reference: "Mateo 4:4" },
    { fullPhrase: "PEDID Y SE OS DARA", hint: "MATEO 7:7", reference: "Mateo 7:7" },
    { fullPhrase: "YO Y EL PADRE UNO SOMOS", hint: "JUAN 10:30", reference: "Juan 10:30" },
    ...
    { fullPhrase: "DE MAS ESTIMA ES EL BUEN NOMBRE QUE LAS MUCHAS RIQUEZAS", hint: "PROVERBIOS 22:1", reference: "Proverbios 22:1" },
    { fullPhrase: "PORQUE LA PAGA DEL PECADO ES MUERTE", hint: "ROMANOS 6:23", reference: "Romanos 6:23" },
    { fullPhrase: "EN LA CASA DE MI PADRE MUCHAS MORADAS HAY", hint: "JUAN 14:2", reference: "Juan 14:2" },
    { fullPhrase: "MAS BUSCAD PRIMERAMENTE EL REINO DE DIOS Y SU JUSTICIA", hint: "MATEO 6:33", reference: "Mateo 6:33" },
    { fullPhrase: "FIATE DE JEHOVA DE TODO TU CORAZON Y NO TE APOYES EN TU PROPIA PRUDENCIA", hint: "PROVERBIOS 3:5", reference: "Proverbios 3:5" },
    { fullPhrase: "EL PRINCIPIO DE LA SABIDURIA ES EL TEMOR DE JEHOVA", hint: "PROVERBIOS 1:7", reference: "Proverbios 1:7" },
    { fullPhrase: "LOS CIELOS CUENTAN LA GLORIA DE DIOS", hint: "SALMO 19:1", reference: "Salmo 19:1" },
    { fullPhrase: "SI DIOS ES POR NOSOTROS QUIEN CONTRA NOSOTROS", hint: "ROMANOS 8:31", reference: "Romanos 8:31" },
    { fullPhrase: "ORANDO EN TODO TIEMPO CON TODA ORACION Y SUPLICA", hint: "EFESIOS 6:18", reference: "Efesios 6:18" },
    { fullPhrase: "EL GOZO DEL SENOR ES VUESTRA FORTALEZA", hint: "NEHEMÍAS 8:10", reference: "Nehemías 8:10" },
    { fullPhrase: "POR GRACIA SOIS SALVOS POR MEDIO DE LA FE", hint: "EFESIOS 2:8", reference: "Efesios 2:8" },
    { fullPhrase: "LA HIERBA SE SECA Y LA FLOR SE MARCHITA", hint: "ISAÍAS 40:8", reference: "Isaías 40:8" },
    { fullPhrase: "MI PUEBLO FUE DESTRUIDO PORQUE LE FALTO CONOCIMIENTO", hint: "OSEAS 4:6", reference: "Oseas 4:6" },
    { fullPhrase: "NO OS CONFORMEIS A ESTE SIGLO", hint: "ROMANOS 12:2", reference: "Romanos 12:2" },
    { fullPhrase: "SOMOS HECHURA SUYA CREADOS EN CRISTO JESUS PARA BUENAS OBRAS", hint: "EFESIOS 2:10", reference: "Efesios 2:10" },
    { fullPhrase: "EL QUE NO AMA NO HA CONOCIDO A DIOS", hint: "1 JUAN 4:8", reference: "1 Juan 4:8" },
    { fullPhrase: "YO ESTOY A LA PUERTA Y LLAMO", hint: "APOCALIPSIS 3:20", reference: "Apocalipsis 3:20" },
    { fullPhrase: "EL QUE PERSEVERE HASTA EL FIN ESTE SERA SALVO", hint: "MATEO 24:13", reference: "Mateo 24:13" },
    { fullPhrase: "NO TEMAS PORQUE YO ESTOY CONTIGO", hint: "ISAÍAS 41:10", reference: "Isaías 41:10" },
    { fullPhrase: "MI YUGO ES FACIL Y LIGERA MI CARGA", hint: "MATEO 11:30", reference: "Mateo 11:30" },
    { fullPhrase: "EL QUE SE HUMILLA SERA ENALTECIDO", hint: "LUCAS 14:11", reference: "Lucas 14:11" },
    { fullPhrase: "SOBRE TODA COSA GUARDADA GUARDA TU CORAZON", hint: "PROVERBIOS 4:23", reference: "Proverbios 4:23" },
    { fullPhrase: "LA LAMPARA DEL CUERPO ES EL OJO", hint: "MATEO 6:22", reference: "Mateo 6:22" },
    { fullPhrase: "NINGUNO PUEDE SERVIR A DOS SENORES", hint: "MATEO 6:24", reference: "Mateo 6:24" },
    { fullPhrase: "EL QUE ESTA EN CRISTO NUEVA CRIATURA ES", hint: "2 CORINTIOS 5:17", reference: "2 Corintios 5:17" },
    { fullPhrase: "MAS LA SENDA DE LOS JUSTOS ES COMO LA LUZ DE LA AURORA", hint: "PROVERBIOS 4:18", reference: "Proverbios 4:18" },
    { fullPhrase: "NO TE DEJES VENCER DE LO MALO SINO VENCE CON EL BIEN EL MAL", hint: "ROMANOS 12:21", reference: "ROMANOS 12:21" },
    { fullPhrase: "HIJO MIO NO TE OLVIDES DE MI LEY", hint: "PROVERBIOS 3:1", reference: "Proverbios 3:1" },
];
